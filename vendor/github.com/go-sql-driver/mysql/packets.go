		...
		if err == nil {
			if !isNull {
				...
				case fieldTypeTiny, fieldTypeShort, fieldTypeInt24, fieldTypeYear, fieldTypeLong,
					fieldTypeLongLong, fieldTypeFloat, fieldTypeDecimal, fieldTypeNewDecimal, fieldTypeDouble, fieldTypeBit, fieldTypeEnum:
					dest[i] = 0
				case fieldTypeVarChar, fieldTypeVarString, fieldTypeString, fieldTypeTinyBLOB, fieldTypeMediumBLOB, fieldTypeLongBLOB, fieldTypeBLOB:
					dest[i] = ""
				case fieldTypeTimestamp, fieldTypeDate, fieldTypeDateTime, fieldTypeNewDate:
					dest[i] = time.Time{}
				default:
					dest[i] = nil
				}
